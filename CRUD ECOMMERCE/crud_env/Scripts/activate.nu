...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ATHIRA M J\PC\Desktop\PYTHON - DJANGO\CRUD ECOMMERCE\crud_env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ATHIRA M J\PC\Desktop\PYTHON - DJANGO\CRUD ECOMMERCE\crud_env\Scripts\deactivate.nu'
